...
INSERT INTO `compartment` VALUES (1,101,1),(2,102,2);
...
INSERT INTO `feedback` VALUES (1,'Great service, smooth ride.',1,'2024-09-17'),(2,'The seat was uncomfortable.',2,'2024-09-16'),(3,'Thật tuyet',3,'2024-09-15'),(4,'ok cam on bau duc',3,'2024-09-14'),(5,'qua ok',4,'2024-09-13'),(6,'ok mik xe dat ve lan xau',5,'2024-09-13'),(7,'qua te hai',5,'2024-09-13');
...
INSERT INTO `passenger` VALUES (1,'Himmel','himmel@gmail.com',28,'British','555-1234-4321'),(2,'John Smith','johnsmith@gmail.com',34,'America','555-5678-4321'),(3,'Rin Tohsaka','emiya@gmail.com',22,' Japan','555-9876-4321'),(4,'Dang Khac Phu','Phudk@gmail.com',26,'Viet Nam','555-6543-4321'),(5,'Đỗ Thành An','maid23344@gmail.com',11,'hola','0967851513');
...
INSERT INTO `payment` VALUES (1,1,1,'Bank','2024-09-01',150),(2,2,2,'Digital Wallet','2024-09-01',50);
...
INSERT INTO `seat` VALUES (1,1,'1A',1,'First Class'),(2,2,'2B',1,'Economy');
...
CREATE TABLE `ticket` (
  ...
  CONSTRAINT `ticket_ibfk_3` FOREIGN KEY (`CompartmentID`) REFERENCES `compartment` (`CompartmentID`),
...
INSERT INTO `ticket` VALUES (1,1,1,'2024-09-01',150,1,1,1,'2024-09-17'),(2,2,2,'2024-09-01',50,2,2,1,'2024-09-17');
...
-- Dump completed on 2024-09-25 20:11:00
