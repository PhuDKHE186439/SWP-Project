                ...
                <div class="account-form-inner">
                    <div class="account-container">
                        <div class="heading-bx left">
                            <h2 class="title-head">Create OTP Security<span>Question</span></h2>
                        ...
                        <form class="contact-bx" action="registerotp" method="post">
                            <div class="row placeani">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input name="answer1" type="text" required="" class="form-control" placeholder="Answer 1">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input name="answer2" type="text" required="" class="form-control" placeholder="Answer 2">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input name="answer3" type="text" required="" class="form-control" placeholder="Answer 3">
                                        </div>
                                    </div>
                                </div>
