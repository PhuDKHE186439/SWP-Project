                        ...
                        <div class="relative">
                            ...
                            <div data-current="Profile" data-easing="ease" data-duration-in="300" data-duration-out="100" class="dash_profile-tabs w-tabs">
                                <div class="dash_profile-menu w-tab-menu">
                                    ...
                                    <a data-w-tab="Role" class="dash_profile-nav-link w-inline-block  w-tab-link w--current" href="Admin2.jsp">
                                        <div>Role</div>
                                    </a>
                                ...
                                <div class="_100 w-tab-content">
                                    <div data-w-tab="Role" class="w-tab-pane w--tab-active">
                                        <div class="profile_form-header">
                                            <div>
                                                <div class="profile_h1">Role Manager</div>
                                            </div>
                                        </div>
                                        <!-- Add Role Section -->
                                                ...
                                                <div class="dash_modal">
                                                    ...
                                                    <div class="w-form">
                                                        <form action="ManageRole" method="post" class="modal_form">
                                                            ...
                                                            <div class="profile_h1">Add Role</div>
                                                            <div class="input-wrapper">
                                                                <label for="roleName" class="profile_label is-modal">Role Name:</label>
                                                                <input type="text" name="roleName" class="input w-input" required>
                                                            </div>
                                                            <input type="hidden" name="action" value="add">
                                                            <input type="submit" class="dash_button w-button" value="Add Role">
                                                        </form>
                                        ...
                                        <!-- Edit/Delete Role Section -->
                                        <div class="profile_section">
                                            <div class="profile_section-head">Edit/Delete Role</div>
                                            <div class="modal_open">
                                                <a href="#" class="outline-button edit w-inline-block">
                                                    <div class="flex-row-outer">
                                                        <div>Edit</div>
                                            ...
                                            <div class="dash_modal">
                                                ...
                                                <div class="w-form">
                                                    <form action="ManageRole" method="post" class="modal_form">
                                                        <div class="input-wrapper">
                                                            <label for="roleSelect" class="profile_label">Select Role</label>
                                                            <select name="roleID" id="roleSelect" class="input w-input" required>
                                                    ...
                                                    <div class="input-wrapper">
                                                        <label for="newRoleName" class="profile_label">New Role Name</label>
                                                        <input class="input w-input" name="newRoleName" placeholder="New Role Name" type="text" required>
                                                    </div>
                                                    <div class="action-buttons">
                                                        <input type="hidden" name="action" value="edit">
                                                        <input type="submit" class="dash_button w-button" value="Rename Role" onclick="return confirm('Are you sure you want to rename this role?')">
                                                    </div>
                                                    <div class="action-buttons">
                                                        <input type="hidden" name="action" value="delete">
                                                        <input type="submit" class="outline-button delete w-inline-block" value="Delete Role" onclick="return confirm('Are you sure you want to delete this role?')">
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
