                        ...
                        <div class="relative">
                            ...
                            <div data-current="Profile" data-easing="ease" data-duration-in="300" data-duration-out="100" class="dash_profile-tabs w-tabs">
                                <div class="dash_profile-menu w-tab-menu">
                                    ...
                                    <a data-w-tab="Role" class="dash_profile-nav-link w-inline-block w-tab-link w--current " >
                                ...
                                <div class="_100 w-tab-content">
                                    <div data-w-tab="Profile" class="w-tab-pane w--tab-active">
                                        ...
                                        <div class="profile_section">
                                            <div class="profile_section-head">Add Role</div>
                                            ...
                                            <div>
                                                ...
                                                <div class="dash_modal">
                                                    ...
                                                    <div class="w-form">
                                                        <form action="ManageRole" id="wf-form-Add-Role" method="post" class="modal_form">
                                                            <div class="profile_h1">Add New Role</div>
                                                            <div class="input-wrapper">
                                                                <label for="roleName" class="profile_label is-modal">Role Name</label>
                                                                <input class="input w-input" maxlength="256" name="roleName" placeholder="Enter role name" type="text" required>
                                                            </div>
                                                            <div class="spacer-s"></div>
                                                            <input type="hidden" name="action" value="add">
                                                            <input type="submit" data-wait="Please wait..." class="dash_button w-button" value="Add Role">
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="profile_section">
                                            <div class="profile_section-head">Edit Role</div>
                                            <div class="profile_flex"></div>
                                            <div>
                                                <div class="modal_open">
                                                    <a href="#" class="outline-button edit w-inline-block">
                                                ...
                                                <div class="dash_modal">
                                                    ...
                                                    <div class="w-form">
                                                        <form action="ManageRole" id="wf-form-Edit-Role" method="post" class="modal_form">
                                                            <div class="profile_h1">Edit Role</div>
                                                            <div class="input-wrapper">
                                                                <label for="roleID" class="profile_label is-modal">Select Role to Edit</label>
                                                        ...
                                                        <div class="input-wrapper">
                                                            <label for="roleName" class="profile_label is-modal">New Role Name</label>
                                                            <input class="input w-input" maxlength="256" name="roleName" placeholder="Enter new role name" type="text" required>
                                                        </div>
                                                        <div class="spacer-s"></div>
                                                        <input type="hidden" name="action" value="edit">
                                                        <input type="submit" data-wait="Please wait..." class="dash_button w-button" value="Edit Role">
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="profile_section">
                                        <div class="profile_section-head">Delete Role</div>
                                        <div class="profile_flex"></div>
                                        <div>
                                            <div class="modal_open">
                                                <a href="#" class="outline-button edit w-inline-block">
                                            ...
                                            <div class="dash_modal">
                                                ...
                                                <div class="w-form">
                                                    <form action="ManageRole" method="post" class="modal_form">
                                                        <div class="profile_h1">Delete Role</div>
                                                        <div class="input-wrapper">
                                                            <label for="roleID" class="profile_label is-modal">Select Role to Delete</label>
                                                            <select class="input w-input" name="roleID" required>
                                                                <option value="" disabled selected>Select Role</option>
                                                                <% for (role r : roles) { %>
                                                                <option value="<%= r.getRoleID() %>"><%= r.getRoleName() %></option>
                                                        ...
                                                        <div class="spacer-s"></div>
                                                        <input type="submit" data-wait="Please wait..." class="dash_button w-button" value="Delete Role" onclick="return confirm('Are you sure you want to delete this role?')">
