<%-- 
    Document   : ForgetPasswordOTP
    Created on : Sep 20, 2024, 5:46:35 PM
    Author     : My Asus
--%>
                                ...
                                <c:forEach items="${list}" var="o">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            OTP Question
                                                <label>OTP Question</label>
                                                <input name="otpquestion" type="text" required="" class="form-control" placeholder="Answer">
                                            </div>
                                        </div>
                                    </div>
                                </c:forEach>
